...
// function pintar(color, xi, yi, xf, yf){
//     mapa.beginPath();
...
// function accion(){
//     console.log(++vida);
//     numero1= prompt('intro el prim num ');
//     numero2= prompt('intro el seg num ');
